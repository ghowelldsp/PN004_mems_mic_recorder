...
HD_PWD='Z:/Documents/DOCS/projects/projects_uploaded/PN004_mems_mic_recorder/fpga_project/memsMicRec_vivado/memsMicRec_vivado.runs/mmcm_clock_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mmcm_clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mmcm_clock.tcl
