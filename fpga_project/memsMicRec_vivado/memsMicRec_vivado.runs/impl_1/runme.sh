...
HD_PWD='Z:/Documents/DOCS/projects/projects_uploaded/PN004_mems_mic_recorder/fpga_project_copy/memsMicRec_vivado/memsMicRec_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log memsMicRec_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source memsMicRec_top.tcl -notrace
